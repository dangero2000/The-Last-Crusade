...
int main(int argc, char* argv[])
{
	...
	// All relative asset paths in the engine resolve from here.
	{
		...
		{
#ifdef __APPLE__
			// On macOS, SDL_GetBasePath() returns Contents/Resources/.
			// The comment in CMakeLists.txt suggests it returns Contents/MacOS/,
			// but testing shows it actually returns Resources/ directly.
			// Keep the "../Resources" path for robustness in case SDL behavior varies.
